...
const initDatabase = async () => {
  ...
  const singleConn = await pool.getConnection();
  try {
  ...
  // Step 2: Use the connection pool to connect to the created database and set up tables
  try {
    await pool.query("USE wpr2101040107");
